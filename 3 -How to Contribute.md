...
# 2 -GitHub Web Contribution Process** (Basic User)

## Beginner’s Guide to Contributing via GitHub Web

### Step 1: Create a GitHub Account

1. **Sign Up**: Go to GitHub and sign up for a free account if you don’t already have one.
2. **Set Up Your Profile**: Fill in your profile details to make it easier for collaborators to recognize you.

### Step 2: Fork the Repository

1. **Navigate to the Repository**: Go to the Guernsey French Digital Record repository.
...
### Step 3: Make Changes Using the Web Interface

1. **Navigate to Your Forked Repository**: Go to your GitHub profile and find the forked repository.
2. **Open the File You Want to Edit**: Click on the file you want to edit. If you want to add a new file, navigate to the folder where you want to add it and click “Add file” > “Create new file”.
3. **Edit the File**: Click the pencil icon (✏️) to edit an existing file or start typing in the new file editor.
4. **Commit Your Changes**: Once you’ve made your changes, scroll down to the “Commit changes” section. Add a descriptive commit message and click “Commit changes”.

### Step 4: Create a Pull Request

1. **Navigate to the Pull Requests Tab**: Go to the original Guernsey French Digital Record repository and click on the “Pull requests” tab.
2. **Create a New Pull Request**: Click the “New pull request” button.
3. **Compare Changes**: Ensure that your forked repository is selected as the “compare” branch and the original repository is the “base” branch.
4. **Create the Pull Request**: Click “Create pull request”. Add a title and description for your pull request, explaining the changes you made, and click “Create pull request” again.

### Step 5: Collaborate and Review

1. **Review Feedback**: Collaborators may review your pull request and provide feedback.
2. **Make Necessary Changes**: If requested, you can make additional changes directly in the web interface. Your pull request will automatically update with these changes.

### Step 6: Merge Your Changes

1. **Merge Approval**: Once your pull request is approved, it will be merged into the main repository.
2. **Celebrate**: Congratulations! You’ve successfully contributed to the Guernsey French Digital Record project.

By following these steps, you can easily contribute to the preservation of the Guernsey French language using only the GitHub web interface. If you have any questions or need further assistance, feel free to ask!

# 3 GitHub and Obsidian Contribution Process
  Detailed process [[1 - Introduction Guide to Using Obsidian with Your GitHub Repository]] but here is the gist 
